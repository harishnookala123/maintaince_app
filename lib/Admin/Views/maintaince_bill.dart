          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.symmetric(vertical: 14, horizontal: 16),
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(15.0)),
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15.0), borderSide: BorderSide(color: Colors.black, width: 1.3)),
                errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15.0), borderSide: BorderSide(color: Colors.red, width: 1.9)),
              ),
              validator: (value) {
                if (value!.isEmpty) {
            ...
            Center(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  textStyle: GoogleFonts.acme(fontSize: 18, fontWeight: FontWeight.w500, letterSpacing: 0.4),
                ),
                child: const Text('Submit',style: TextStyle(fontWeight: FontWeight.w300,color: Colors.white),),
              ),
            ),
          ],
        ),
